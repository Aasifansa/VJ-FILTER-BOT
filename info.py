...
auth_channel = environ.get('AUTH_CHANNEL', '-1002217420645') # give your force subscribe channel id here else leave it blank
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002463365481')).split()]
